...
- (NSString*)readForwardFromCharactorIndex:(int)charactorIndex limitCharNum:(int) chNumber
{
    ...
    debugLog(@"startIndex = %d", pageInfo.startIndex);
    debugLog(@"stopIndex = %d", pageInfo.stopIndex);
    debugLog(@"length = %d", [pageInfo.drawStr length]);
    debugLog(@"charactorIndex = %d", charactorIndex);
