...
public:
    ...
    //
    static OEBCSSStyle* createOEBCSSStyle(const AttributeMap &map);
    static OEBCSSStyle* createOEBCSSStyle(ZLTextStyleEntry &entry);
...
public:
    ...
    // 
    OEBCSSStyle* createOEBCSSStyle(NSString *tag, NSString *aClass);
