...
public:
    ...
    {
        m_charset = HK_ENCODING_ENCODING_DEFAULT;
    }

    virtual ~HandleUniversalDetector()
    {}

    virtual void Report(int charset)
    {
        m_charset = charset;
    }
...
int uchardet_handle_data(uchardet_t ud, const char * data, size_t len)
{
	...
	if(reinterpret_cast<HandleUniversalDetector*>(ud)->IsDone())
		ret = NS_DONE;
    return ret;
}
...
int uchardet_get_charset(uchardet_t ud)
{
