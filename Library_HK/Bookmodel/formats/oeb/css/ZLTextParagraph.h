...
public:
    ...
    LengthType length(Length name) const;
...
//inline LengthType ZLTextStyleEntry::getLength(){}
...
inline bool ZLTextStyleEntry::textColorSupported() const { return (!myTextColor.empty()); }
inline const std::string &ZLTextStyleEntry::textColor() const { return myTextColor; }
inline void ZLTextStyleEntry::setTextColor(const std::string &textColor) { myTextColor = textColor;}
